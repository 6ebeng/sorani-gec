...
Note: "Phase D" was internal reviewer-report jargon, and the "phase 1/2/3" numbering came from a separate retrain plan; neither reflects chronology (the `phase2_clean` run happened *after* `phase_d`). Hence the rename.
