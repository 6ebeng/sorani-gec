...
#   mkdir -p results/campaign_2_multiseed
#
# Usage:
#   bash scripts/train_campaign_2_multiseed.sh                  # runs 3 seeds both models
#   bash scripts/train_campaign_2_multiseed.sh --seeds "42"     # single seed smoke test
#   bash scripts/train_campaign_2_multiseed.sh --baseline-only  # skip morphaware
#   bash scripts/train_campaign_2_multiseed.sh --morph-only     # skip baseline
#
...
PATIENCE=5
MAX_LEN=256
RESULTS_DIR="results/campaign_2_multiseed"
RUN_BASELINE=true
RUN_MORPHAWARE=true
...
echo "==================================================================="
echo "Campaign 2 multiseed training (R2 + R32)"
echo "  Seeds:      $SEEDS"
echo "  Data:       $DATA_DIR"
...
echo ""
echo "==================================================================="
echo "Campaign 2 training complete — $(date -u '+%Y-%m-%d %H:%M:%S UTC')"
