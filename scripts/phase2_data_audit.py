"""Phase 2 data-integrity audit for splits_v2 (audit rows 2.1-2.5).
...
Read-only: writes a JSON report to ``results/phase2_data_audit.json`` and
prints a summary. It does NOT modify the splits.

Usage:
    cd Implementation/sorani-gec
    python scripts/phase2_data_audit.py
"""
...
OUT = Path("results/phase2_data_audit.json")
...
def main() -> None:
    ...
    # --- summary ---
    print("=" * 64)
    print("PHASE 2 DATA AUDIT  (data/splits_v2)")
    print("=" * 64)
